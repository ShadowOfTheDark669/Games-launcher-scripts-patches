...
# <ins>Note:</ins>
The executables are often flagged as malware from Chrome, Firefox or antiviruses. This is a false positive !

# Credits
## BatToExePortable: https://github.com/Makazzz/BatToExePortable
## DxWrapper: https://github.com/elishacloud/dxwrapper

# Steps to reproduce identical binaries
1. Dowload the `BatToExe` from the repo above and install it.
...
5. Tick the icon checkbox if an `.ico` file was downloaded and select the `.ico` file.
